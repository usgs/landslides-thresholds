...
make_plot('Rainfall at Marine View Dr. & 116 St. SW', column_0_mvd, rain_in_mvd, daily_in_mvd.index, daily_in_mvd.values, name='MVD116_rain_in_day_lt.png')
#
## ------------------------
...
#
make_plot('Rainfall at Mukilteo Lighthouse Park', column_0_mlp, rain_in_mlp, daily_in_mlp.index, daily_in_mlp.values, name='MLP_rain_in_day_lt.png')
#
## ------------------------
...
#
make_plot('Rainfall at Mukilteo Wastewater Plant', column_0_mwwd, rain_in_mwwd, daily_in_mwwd.index, daily_in_mwwd.values, name='MWWD_rain_in_day_lt.png')
#
## ------------------------
...
#
make_plot('Rainfall at Waterton Circle Station A', column_0_wca, rain_in_wca, daily_in_wca.index, daily_in_wca.values, name='MWatA_rain_in_day_lt.png')
#
