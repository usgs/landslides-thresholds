...
grep -f dates2011Muk.txt ./output/3-15/ThArchive02.txt > ./3-15/slides_cum.txt
# Extract and sort hourly values
grep -v [a-z] ./output/3-15/ThArchive02.txt | awk '{print $3}' | grep -v 99.00 | sort -g > ./3-15/hourly_sort.txt
# Extract and sort AWI hourly values
grep -v [a-z] ./output/3-15/ThArchive02.txt | awk '{print $9}' | grep -v 99.00 | sort -g > ./3-15/awi_sort.txt
